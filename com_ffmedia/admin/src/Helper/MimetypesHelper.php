...
class MimetypesHelper
{
	 ...
	 */
	public function getMimetypes($extensions)
	{
		if (empty($extensions))
		{
			return false;
		...
		foreach ($items as $item)
		{
			...
			if (!isset($this->types[$item])) {
				Factory::getApplication()->enqueueMessage(Text::_('COM_FFMEDIA_ERROR_EXTENSION_NOT_IN_LIST') . ' '. $item, 'warning');
				continue;
			}
			...
			{
				Factory::getApplication()->enqueueMessage(Text::_('COM_FFMEDIA_ERROR_EXTENSION_FORBIDDEN') . ' '. $item, 'warning');
				continue;
			}
	...
	/*
	 * Get a list of extensions given a mimetype
	 */
