...
class ImagesController extends AdminController
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_FFMEDIA_IMAGES';
	...
	public function deleteifempty()
	{
		...
		$activepath = $app->getUserState('com_ffmedia.images.filter.activepath');
		$parts = explode('/', $activepath);
		array_pop($parts);
		$newactivepath = implode('/', $parts);
		$app->setUserState('com_ffmedia.images.filter.activepath', $newactivepath);
