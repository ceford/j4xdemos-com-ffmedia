...
class Subject
{
     ...
     * @return bool
     * @throws \J4xdemos\Component\Ffmedia\Administrator\Sanitizer\Exceptions\NestingException
     */
    public function hasInfiniteLoop(array $subjects = [], $level = 1)
    {
        if ($level > $this->useNestingLimit) {
            throw new \J4xdemos\Component\Ffmedia\Administrator\Sanitizer\Exceptions\NestingException('Nesting level too high, aborting', 1570713498, null, $this->getElement());
        }
