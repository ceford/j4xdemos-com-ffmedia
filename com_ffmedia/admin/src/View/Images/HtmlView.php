...
namespace J4xdemos\Component\Ffmedia\Administrator\View\Images;
...
/**
 * View class for a list of ffmedia images.
 *
 * @since  4.0
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_FFMEDIA_IMAGES'), 'images ffmedia');
